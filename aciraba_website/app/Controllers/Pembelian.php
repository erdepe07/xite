...
{
    protected $uri,$session,$breadcrumb,$sidetitle = "Pembelian";
	...
	public function formpembelian()
	{
		...
		if ($this->uri->getSegment(3) != ''){
			...
			$data = [
				...
				"detailpembelian" => $datajson->hasiljson[0]->dataquery
			];
		}else{
			$data = [
				"isedit"=> "false",
	...
	public function simpanpembelian(){
		...
		$datapost = [
			...
			'ISEDIT'=> service('request')->getPost('ISEDIT'),
			'UBAHTANPABARANG'=> service('request')->getPost('UBAHTANPABARANG'),
			'PAKSA_SIMPAN'=> service('request')->getPost('PAKSA_SIMPAN'),
		];

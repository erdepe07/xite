                        ...
                        <div class="portlet-body">
                            <div class="mb-3">
                                ...
                                <div class="nav nav-lines" id="nav1-tab">
                                    <a class="nav-item nav-link tabmenupengguna active" id="nav1-home-tab" data-toggle="tab" href="#nav1-home">Daftar Pegawai / Rekanan</a>
                                    <a class="nav-item nav-link tabmenupengguna" id="nav1-profile-tab" data-toggle="tab" href="#nav1-profile"><div id="keterangantabpengguna">Tambah Pegawai / Rekanan</div></a>
                                </div>
                                <!-- END Nav -->
                            </div>
                            <!-- BEGIN Tab -->
                            <div class="tab-content" id="nav1-tabContent">
                                <div class="tab-pane fade show active" id="nav1-home"> 
                                    <input id="pencarianpenggunaha" type="text" class="mb-2 form-control" placeholder="Filter ? Silahkan ketikan namapengguna, username atau idpengguna"> 
                                ...
                                <!-- BEGIN Form -->
                                    ...
                                    <div class="form-group row">
                                        <label for="rekening" class="col-sm-2 col-form-label">Login Di Outlet</label>
                                        <div class="col-sm-10">
                                            <!-- BEGIN Input Group -->
                                            <select class="form-control" id="cmblokasioutlettambahpegawai"></select>
                                            <!-- END Input Group -->
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="statuspegawai" class="col-sm-2 col-form-label">By Pass Tanpa Verif</label>
                                        <div class="col-sm-10" >                                          
                                            <div class="custom-control custom-control-lg custom-switch">
                                                <input style="cursor: pointer;" type="checkbox" class="custom-control-input" id="bypass_pengguna" name="bypass_pengguna">
                                                <label style="cursor: pointer;" class="custom-control-label" for="bypass_pengguna">By Pass Tanpa Verifikasi</label>
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function () {
    $('#cmblokasioutlettambahpegawai').select2({
        allowClear: true,
        placeholder: 'Untuk Login Ke Outlet ?',
        ajax: {
            ...
            processResults: function (data) {
                ...
                parseJSON.unshift({
                    namaoutlet: "Semua Outlet",
                    group: "0"
                });
                return {
                    results: $.map(parseJSON, function (item) {
                        return {
                            text: item.namaoutlet,
                            id: item.group,
                        }
                    })
                }

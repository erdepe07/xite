    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl full_modal-dialog">
        <div class="modal-content full_modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-3">Sub Perusahaan : <span class="subperusahaan_perfaktur"></span></div>
                </div>
                <hr>
                <div class="row ml-3 mr-3">
                    <div class="col"><button id="cetak_pdf_penjualan_perfaktur" class="btn btn-block btn-danger justify-content-end"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></div>
                    <div class="col"><button id="cetak_excel_penjualan_perfaktur" class="btn btn-block btn-success"><i class="fa-solid fa-file-excel"></i> Export Excel</button></div>
                </div>
                <hr>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl full_modal-dialog">
        <div class="modal-content full_modal-content">
            ...
            <div class="modal-body">
                ...
                <hr>
                <div class="row ml-3 mr-3">
                    <div class="col"><button id="cetak_pdf_penjualan_barang" class="btn btn-block btn-danger justify-content-end"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></div>
                    <div class="col"><button id="cetak_excel_penjualan_barang" class="btn btn-block btn-success"><i class="fa-solid fa-file-excel"></i> Export Excel</button></div>
                </div>
                <hr>
...
<script>
function cetakpdf_penjualan_perbarang(id,format_file) {
    let KONDISI;
    if (id == "cetak_excel_penjualan_perfaktur" || id == "cetak_pdf_penjualan_perfaktur"){
        KONDISI = "penjualanperfaktur";
    }else if (id == "cetak_excel_penjualan_barang" || id == "cetak_pdf_penjualan_barang"){
        KONDISI = "penjualanperbarang";
    }
    let PERIODEAWAL = safeValNull($("#laporan_penjualan_tanggalwal").val());
    let PERIODEAKHIR = safeValNull($("#laporan_penjualan_tanggalakhir").val());
    let CARABAYAR = safeValNull($("#laporan_penjualan_carabayar").val());
    let OUTLET = safeValNull($("#laporan_penjualan_outlet").val());
    let IDPELANGGAN = safeValNull($("#laporan_penjualan_customer").val());
    let KODEBARANG = safeValNull($("#laporan_penjualan_barang").val());
    let KODESUPLIER = safeValNull($("#laporan_penjualan_supplier").val());
    let GROUPELANGGAN = safeValNull($("#laporan_penjualan_groumember").val());
    let KODEKATEGORI = safeValNull($("#laporan_penjualan_kategori").val());
    let DARISUBPERUSAHAAN = safeValNull($("#laporan_penjualan_sub_perusahaan").val());
    let KEPEMILIKAN = safeValNull($("#laporan_penjualan_sub_perusahaan option:selected").text());
    let urlcetak = baseurljavascript + "laporan/file_penjualan?" +
        "periodeawal=" + encodeURIComponent(PERIODEAWAL) +
        "&periodeakhir=" + encodeURIComponent(PERIODEAKHIR) +
        "&carabayar=" + encodeURIComponent(CARABAYAR) +
        "&supplier=" + encodeURIComponent(KODESUPLIER) +
        "&kategori=" + encodeURIComponent(KODEKATEGORI) +
        "&barang=" + encodeURIComponent(KODEBARANG) +
        "&outlet=" + encodeURIComponent(OUTLET) +
        "&pelanggan=" + encodeURIComponent(IDPELANGGAN) +
        "&group=" + encodeURIComponent(GROUPELANGGAN) +
        "&subperusahaan=" + encodeURIComponent(DARISUBPERUSAHAAN) +
        "&kondisi=" + encodeURIComponent(KONDISI)+
        "&kepemilikan=" + encodeURIComponent(KEPEMILIKAN) +
        "&format_file=" + encodeURIComponent(format_file) +
        "&stream_file=1";
    window.open(urlcetak, "_blank");
}
$("#cetak_pdf_penjualan_barang, #cetak_pdf_penjualan_perfaktur").on("click", function() {
   cetakpdf_penjualan_perbarang(this.id,"pdf");
});
$("#cetak_excel_penjualan_barang, #cetak_excel_penjualan_perfaktur").on("click", function() {
   cetakpdf_penjualan_perbarang(this.id,"excel");
});

...
function informasirow1dashboard(){
	$.ajax({
		...
		success: function (response) {
			$("#jumlahanggota_dashboard").html(new Intl.NumberFormat('id-ID').format(response.dataquery[0].TOTALMEMBER))
			$("#jumlahbarangaktif_dashboard").html(new Intl.NumberFormat('id-ID').format(response.dataquery[0].ITEMAKTIF))
			$("#jumlahbarangtidakaktif_dashboard").html(new Intl.NumberFormat('id-ID').format(response.dataquery[0].ITEMAKTIFKUANTITI))
		}
	});
}
function informasirow2dashboard(){
	$.ajax({
		...
		dataType: 'json',
		success: function (response) {
			$("#trxhariini_dashboard").html(new Intl.NumberFormat('id-ID').format(response.dataquery[0].BANYAKTRX))

                    ...
                    +"<div class=\"col-md-4\">"
                        +"<div class=\"portlet\">"
                            ...
                            +"<div class=\"portlet-footer\">"
                                +"<button onclick=\"pindahoutlet('"+response.dataquery[i].KODEOUTLET+"','"+response.dataquery[i].NAMAOUTLET+"')\" class=\"btn btn-success mr-2\"><i class=\"fa fa-check mr-2\"></i>Pindah Oulet</button>"

                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="aktifkanbestbuy" name="aktifkanbestbuy">
                                                            <label class="custom-control-label" for="aktifkanbestbuy">Aktifkan Best Buy</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="barangbukanstok" name="barangbukanstok">
                                                            <label class="custom-control-label" for="barangbukanstok">Barang Ini Bukan Stok [Jasa]</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="stokdapatminus" name="stokdapatminus">
                                                            <label class="custom-control-label" for="stokdapatminus">Stok Dapat Minus</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="izinkan_jual_dibawah_hpp" name="izinkan_jual_dibawah_hpp">
                                                            <label class="custom-control-label" for="izinkan_jual_dibawah_hpp">Izinkan Jual Dibawah HPP</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <div class="input-group-prepend">
                                <span data-toggle="modal" data-target="#modal6" class="input-group-text btn-warning btn">Pilih Barang</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?= base_url();?>scripts/masterdata/masteritem2.js"></script>
...
let hargajualbaruPecahSatuan = new AutoNumeric("#hargajualbaru", {decimalCharacter : ',',digitGroupSeparator : '.',})
let hppprodukbaruPecahSatuan = new AutoNumeric("#hppprodukbaru", {decimalCharacter : ',',digitGroupSeparator : '.',})
let dariPembelian = 0;
$(document).ready(function () {
    ...
    <?php if ($BARANG_ID != ""){ ?> 
        ...
        $("#izinkan_jual_dibawah_hpp").prop('checked', <?= strtolower($JUAL_DIBAWAH_HPP) ;?>);
        quillHtml.clipboard.dangerouslyPasteHTML('<?= $KETERANGANBARANG ;?>');

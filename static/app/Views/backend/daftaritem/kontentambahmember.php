                        ...
                        <div class="portlet-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="info_member_biodata">
                                    <div style="font-size:2em;font-family: 'Irish Grover', cursive;" class="text-center"><i class="fa-solid fa-arrow-down fa-bounce"></i> Tentukan Status Anggota Ini <i class="fa-solid fa-arrow-down fa-bounce"></i></div>
                                    <div id="statusmembernya" class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
                                        <label style="cursor:pointer" 
                                            id="btn-status-item-1" 
                                            class="btn-status-item btn btn-flat-success <?= $STATUSAKTIF == "" || $STATUSAKTIF == "1" ? "active" : "" ;?>">
                                            <input type="radio" 
                                                name="rb_statusmembernya" 
                                                value="1" 
                                                id="rb_aktif" 
                                                <?= $STATUSAKTIF == "" || $STATUSAKTIF == "1" ? "checked" : "" ;?>>
                                            Member Ini Aktif
                                        </label>

                                        <label style="cursor:pointer" 
                                            id="btn-status-item-0" 
                                            class="btn-status-item btn btn-flat-warning <?= $STATUSAKTIF == "0" ? "active" : "" ;?>">
                                            <input type="radio" 
                                                name="rb_statusmembernya" 
                                                value="0" 
                                                id="rb_tidakaktif" 
                                                <?= $STATUSAKTIF == "0" ? "checked" : "" ;?>>
                                            Member Ini Tidak Aktif
                                        </label>
                                    </div>
<hr>

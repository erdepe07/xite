                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-4">
                                ...
                                <input type="text" class="form-control" id="kodebarangkartustok" value="<?= $SEGMENT; ?>" placeholder="Masukan kodebarang untuk dicek kartu stoknya">
                            </div>
...
<script type="text/javascript">
    ...
    let lastDay = moment().format('DD-MM-YYYY');
    // Tanggal awal = 30 hari ke belakang dari hari ini
    let firstDay = moment().subtract(30, 'days').format('DD-MM-YYYY');

    // Set nilai ke input
    $('#filterawalkartustok').val(firstDay);
    $('#filteraakhirkartustok').val(lastDay);
